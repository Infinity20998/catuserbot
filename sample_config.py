...
class Config(object):
    ...
    CLEAN_WELCOME = bool(os.environ.get("CLEAN_WELCOME", None))
    ...
    IALIVE_PIC = [x for x in os.environ.get("IALIVE_PIC", "").split()]
    ...
    # For updater plugin
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Infinity1335/catuserbot.git"
    )
