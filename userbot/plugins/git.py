...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/Infinity1335/infineko) to open this bot source code\
        \nClick [here](https://github.com/sandy1709/catuserbot) to open the original bot source code\
